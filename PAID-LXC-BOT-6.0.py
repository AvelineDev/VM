...
DISCORD_TOKEN = os.getenv('DISCORD_TOKEN', 'MTUwMDc3OTM3Njc0MzE1Mzc0NA.GJqAcE.p14I4ijyv4NgWOaZ3XkWfdnwCkLYsmkeJjo-AQ')
BOT_NAME = os.getenv('BOT_NAME', 'NexuraCloud')
PREFIX = os.getenv('PREFIX', '!')
YOUR_SERVER_IP = os.getenv('YOUR_SERVER_IP', '134.195.199.35')
MAIN_ADMIN_ID = int(os.getenv('MAIN_ADMIN_ID', '1301858723072966666'))
